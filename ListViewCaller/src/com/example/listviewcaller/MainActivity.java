...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Contact(R.drawable.img3,"Charlie","09181234567"));
        list.add(new Contact(R.drawable.img4,"Delta","0917123467"));
        list.add(new Contact(R.drawable.img5,"Echo","2557777"));
        list.add(new Contact(R.drawable.img6,"Foxtrot","2541501"));
